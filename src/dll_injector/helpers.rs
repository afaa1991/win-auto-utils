...
pub(crate) fn get_module_base_address(
    pid: u32,
    module_name: &str,
) -> Result<usize, DllInjectorError> {
    crate::snapshot::get_module_base_address(pid, module_name).ok_or_else(|| {
        DllInjectorError::Other(format!(
        ...
        OpenProcess(PROCESS_ALL_ACCESS, false, pid)
            ...
            .and_then(|handle| {
                if handle.is_invalid() {
                    Err(DllInjectorError::OpenProcessFailed(format!(
